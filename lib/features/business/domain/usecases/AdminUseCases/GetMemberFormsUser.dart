...
class GetMemberFormsUser extends Usecase<List<BusinessMemberForm>, GetMemberFormsParams> {
  final MemberAdminRepository repository;
  GetMemberFormsUser({required this.repository});

  @override
  Future<Either<Failure, List<BusinessMemberForm>>> call(GetMemberFormsParams params) {
    return repository.getMemberForms(businessId: params.businessId, memberId: params.memberId);
  }
}